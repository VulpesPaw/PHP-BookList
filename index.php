...
if ($_GET['logout'] == 'logout') { // sends to logoutscreen
    header("Location:https://my-book-list.richardte18it.repl.co/logout.php");
    exit();//exit is after every header to ensure it directs directly
} else if ($_GET['login'] == 'signin') {
    header("Location:https://my-book-list.richardte18it.repl.co/validation/login.php");
    exit();
    ...
    header("Location:https://my-book-list.richardte18it.repl.co/");
    exit();
}
